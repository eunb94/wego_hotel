...
'                                <ul class="navbar-nav">'+
'                                    <li id="hotelgo" class="nav-item">'+
'                                        <a id="hotel_go" class="nav-link" href="#" style=" font-size: 26px;">HOTEL</a>'+
'                                    </li>'+
'                                    <li id="tourismgo" class="nav-item">'+
'                                        <a class="nav-link" href="about.html" style=" font-size: 26px;">TOURISM</a>'+
'                                    </li>'+
'                                    <li id="trafficgo" class="nav-item">'+
'                                        <a class="nav-link" href="packages.html" style=" font-size: 26px;">TRAFFIC</a>'+
'                                    </li>'+
'                                    <li id="reviewgo" class="nav-item">'+
'                                        <a class="nav-link" href="packages.html" style=" font-size: 26px;">REVIEW</a>'+
'                                    </li>'+
...
// '                                        </div>'+
// '                                    </li>'+ 
'                                    <li id="teamgo" class="nav-item">'+
'                                        <a class="nav-link" href="contact.html" style=" font-size: 26px;">TEAM</a>'+
'                                    </li>'+
'                                </ul>'+
'                            </div>'+
'                            <a href="#" class="btn_1 d-none d-lg-block" style="margin-left:10%; border-radius:3px;">Login</a>'+
'                            <a href="#" class="btn_1 d-none d-lg-block" style="margin-left:1%; border-radius:3px;">Join</a>'+
'                        </nav>'+
'                    </div>'+
'                </div>'+
'            </div>'+
